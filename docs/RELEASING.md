...
- `.prettierignore`
  - excludes Release Please generated changelog entries from the Prettier gate
...
`CHANGELOG.md` is generated by Release Please and is intentionally excluded from the Prettier check so release PRs do not fail on tool-generated markdown formatting.
